# Цель проекта
Научиться использовать базовые функции Git для управления версиями проекта и работы с удаленным репозиторием на GitHub.
...
- `git log` - проверил истрию коммитов
